...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.082352899015,0.262744992971,0.611765027046);

  float alphaComponent = 0.659999966621;
