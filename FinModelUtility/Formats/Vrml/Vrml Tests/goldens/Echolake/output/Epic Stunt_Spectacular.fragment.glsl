...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.20000000298) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.607842981815,0.207843005657,0.207843005657)*texture(texture0, uv0).rgb;
