...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.20000000298) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.509804010391,0.572548985481,0.627451002598)*texture(texture0, uv0).rgb;
