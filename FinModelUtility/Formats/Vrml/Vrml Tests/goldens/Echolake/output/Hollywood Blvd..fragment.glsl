...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.20000000298) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.066666699946,0.156863003969,0.470587998629)*texture(texture0, uv0).rgb;
