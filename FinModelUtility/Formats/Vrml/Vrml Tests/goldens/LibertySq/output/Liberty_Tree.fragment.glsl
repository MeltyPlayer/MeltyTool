...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.20000000298) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.913725972176,0.913725972176,0.003921569791)*texture(texture0, uv0).rgb;
