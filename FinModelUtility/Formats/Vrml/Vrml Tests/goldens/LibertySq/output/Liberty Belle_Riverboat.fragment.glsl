...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.20000000298) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.117646999657,0.27058801055,0.96078401804)*texture(texture0, uv0).rgb;
