...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.560783982277,0.40000000596,0.278430998325)*texture(texture0, uv0).rgb;
