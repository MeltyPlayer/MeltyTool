...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.501960992813)*texture(texture0, uv0).rgb;

  float alphaComponent = 0.639999985695*texture(texture0, uv0).a;
