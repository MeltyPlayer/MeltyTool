...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.776471018791)*texture(texture0, uv0).rgb;

  float alphaComponent = 0.459999978542*texture(texture0, uv0).a;
