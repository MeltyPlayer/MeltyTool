...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.20000000298) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.0,0.0,1.0)*texture(texture0, uv0).rgb;

  float alphaComponent = 0.509999990463*texture(texture0, uv0).a;
