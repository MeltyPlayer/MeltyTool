...
void main() {
  ...
  vec3 colorComponent = color_3dsColor2*mergedLightSpecularColor.rgb*(vec3(0.6000000238418579) + vec3(0,1,0)) + (ambientLightColor.rgb*vec3(0.800000011920929) + mergedLightDiffuseColor.rgb)*texture(texture0, uv0).rgb;
