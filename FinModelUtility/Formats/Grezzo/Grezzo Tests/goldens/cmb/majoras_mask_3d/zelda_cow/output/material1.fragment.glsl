...
void main() {
  ...
  vec3 colorComponent = clamp((ambientLightColor.rgb*vec3(0.4000000059604645) + mergedLightDiffuseColor.rgb*vec3(0.49803921580314636))*texture(texture0, uv0).rgb*vec3(2), 0, 1);
