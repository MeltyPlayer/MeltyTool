...
void main() {
  ...
  vec3 colorComponent = vertexColor0.rgb*(ambientLightColor.rgb*vec3(0.4000000059604645) + mergedLightDiffuseColor.rgb*vec3(0.49803921580314636) + mergedLightSpecularColor.rgb)*texture(texture0, uv0).rgb*vec3(2) + texture(texture1, asin(normalUv) / 3.14159 + 0.5).rgb;
