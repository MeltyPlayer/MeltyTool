...
void main() {
  ...
  vec3 colorComponent = clamp(clamp(vertexColor0.rgb*(ambientLightColor.rgb*vec3(0.40000000596) + mergedLightDiffuseColor.rgb*vec3(0.498039215803) + mergedLightSpecularColor.rgb)*texture(texture0, uv0).rgb*vec3(2.0), 0.0, 1.0) + texture(texture1, sphericalReflectionUv).rgb, 0.0, 1.0);
