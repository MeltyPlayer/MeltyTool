...
void main() {
  ...
  vec3 colorComponent = (vec3(0.501960813999)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0, uv0).rgb + vec3(0.701960802078)*mergedLightSpecularColor.rgb;
