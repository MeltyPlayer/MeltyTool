...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*texture(texture0, uv0).rgb + vec3(1,1,0.501960813999176)*texture(texture1, uv1).rgb*mergedLightSpecularColor.rgb;
