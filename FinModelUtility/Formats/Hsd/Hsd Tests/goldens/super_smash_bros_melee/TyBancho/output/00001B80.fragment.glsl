...
void main() {
  ...
  vec3 colorComponent = (vec3(0.20000000298)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.298039227724)*texture(texture0, uv0).rgb + vec3(0.627451002598)*texture(texture0, uv0).rgb*mergedLightSpecularColor.rgb;
