...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.2980392277240753)*texture(texture0, uv0).rgb + vec3(0.6274510025978088)*texture(texture0, uv0).rgb*mergedLightSpecularColor.rgb;
