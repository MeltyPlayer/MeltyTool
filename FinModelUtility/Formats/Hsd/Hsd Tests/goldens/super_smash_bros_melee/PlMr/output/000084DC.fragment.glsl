...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*texture(texture0, uv0).rgb + vec3(0.4000000059604645)*texture(texture1, uv1).rgb*mergedLightSpecularColor.rgb;
