...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*texture(texture0, uv0).rgb + vec3(0.40000000596)*texture(texture1, uv1).rgb*mergedLightSpecularColor.rgb;
