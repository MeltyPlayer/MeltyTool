...
void main() {
  ...
  vec3 colorComponent = (vec3(0.596078455448,0.533333361149,0.505882382393)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0, uv0).rgb;
