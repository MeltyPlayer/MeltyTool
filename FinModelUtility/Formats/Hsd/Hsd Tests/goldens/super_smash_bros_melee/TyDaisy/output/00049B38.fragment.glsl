...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*vec3(0.701960802078)*texture(texture0, uv0).rgb + vec3(0.701960802078)*mergedLightSpecularColor.rgb;
