...
void main() {
  ...
  vec3 colorComponent = (mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.800000011920929) + vec3(0.7019608020782471)*mergedLightSpecularColor.rgb)*texture(texture0, sphericalReflectionUv).rgb;
