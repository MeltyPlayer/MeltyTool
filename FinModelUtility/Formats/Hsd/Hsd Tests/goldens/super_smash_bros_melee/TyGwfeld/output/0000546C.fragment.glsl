...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.41960784792900085,0,0.1568627506494522) + vec3(0.7019608020782471,0.501960813999176,0.501960813999176)*mergedLightSpecularColor.rgb;
