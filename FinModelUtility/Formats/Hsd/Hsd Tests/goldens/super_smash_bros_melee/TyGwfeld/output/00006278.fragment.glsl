...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.501960813999176,0.3803921639919281,0.20000000298023224);

  float alphaComponent = 0.6000000238418579;
