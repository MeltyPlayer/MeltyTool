...
void main() {
  ...
  vec3 colorComponent = (vec3(0.349019616842,0.250980407,0.149019613862)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.349019616842,0.250980407,0.149019613862);
