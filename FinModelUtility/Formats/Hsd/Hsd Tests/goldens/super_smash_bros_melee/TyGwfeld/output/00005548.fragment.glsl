...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*vec3(0.419607847929,0.0,0.156862750649) + vec3(0.701960802078,0.501960813999,0.501960813999)*mergedLightSpecularColor.rgb;
