...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*texture(texture0, uv0).rgb + vec3(0.600000023842,0.600000023842,0.501960813999)*mergedLightSpecularColor.rgb;
