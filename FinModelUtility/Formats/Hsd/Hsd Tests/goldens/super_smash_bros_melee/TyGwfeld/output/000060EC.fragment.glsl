...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*texture(texture0, uv0).rgb + vec3(0.6000000238418579,0.6000000238418579,0.501960813999176)*mergedLightSpecularColor.rgb;
