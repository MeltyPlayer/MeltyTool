...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*vec3(0.109803922474,0.109803922474,0.090196080506) + vec3(0.372549027205)*mergedLightSpecularColor.rgb;
