...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*texture(texture0.sampler, transformUv3d(texture0.transform3d, uv0)).rgb + mergedLightSpecularColor.rgb;
