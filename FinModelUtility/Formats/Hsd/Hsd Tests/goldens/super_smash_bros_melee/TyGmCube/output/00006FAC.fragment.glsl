...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*vec3(0.015686275437,0.015686275437,0.003921568859) + vec3(0.172549024224,0.211764708161,0.211764708161)*mergedLightSpecularColor.rgb;
