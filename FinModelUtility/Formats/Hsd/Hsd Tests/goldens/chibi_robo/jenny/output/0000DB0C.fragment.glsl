...
void main() {
  vec3 colorComponent = (vec3(0.501960813999)*ambientLightColor.rgb + vec3(1.0))*vec3(2.0)*vec3(0.800000011921,1.0,0.600000023842)*vertexColor0.rgb*texture(texture0, uv0).rgb;
