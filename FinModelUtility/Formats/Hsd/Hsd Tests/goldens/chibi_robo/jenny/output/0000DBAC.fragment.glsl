...
void main() {
  vec3 colorComponent = (vec3(0.501960813999)*ambientLightColor.rgb + vec3(1.0))*vec3(2.0)*vec3(0.0,0.800000011921,0.0)*vertexColor0.rgb*texture(texture0.sampler, transformUv3d(texture0.transform3d, uv0)).rgb;
