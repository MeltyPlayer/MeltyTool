...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*vec3(0.65098041296)*vec3(0.300000011921) + texture(texture0, sphericalReflectionUv).rgb*vec3(0.699999988079);
