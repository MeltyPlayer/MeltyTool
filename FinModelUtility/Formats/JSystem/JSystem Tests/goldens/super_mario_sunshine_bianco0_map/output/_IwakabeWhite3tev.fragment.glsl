...
void main() {
  ...
  float alphaComponent = (texture(texture0.sampler, texture0.transform2d * vec3((uv0).x, (uv0).y, 1)).a*0.4980392156862745 + texture(texture1.sampler, texture1.transform2d * vec3((uv1).x, (uv1).y, 1)).a*0.5019607843137255)*vertexColor0.a;
