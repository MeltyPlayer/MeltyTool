...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.6509804129600525)*vec3(0.30000001192092896) + texture(texture0, asin(normalUv) / 3.14159 + 0.5).rgb*vec3(0.699999988079071);
