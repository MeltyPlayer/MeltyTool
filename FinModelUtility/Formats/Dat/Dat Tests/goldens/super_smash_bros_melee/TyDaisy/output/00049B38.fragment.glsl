...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.7019608020782471)*texture(texture0, uv0).rgb + vec3(0.7019608020782471)*mergedLightSpecularColor.rgb;
