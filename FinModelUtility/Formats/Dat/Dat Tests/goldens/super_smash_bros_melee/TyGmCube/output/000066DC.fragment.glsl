...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.2980392277240753) + vec3(0.7647058963775635,0.800000011920929,0.800000011920929)*mergedLightSpecularColor.rgb;
