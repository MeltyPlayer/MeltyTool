...
void main() {
  ...
  vec3 colorComponent = (mergedLightDiffuseColor.rgb*vec3(2)*vec3(0.7019608020782471) + mergedLightSpecularColor.rgb)*texture(texture0, asin(normalUv) / 3.14159 + 0.5).rgb;
