...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor12345 + texture(texture0, uv0).rgb*color_GxMaterialColor11*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor11), 0, 1), 0, 1);
