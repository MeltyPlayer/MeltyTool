...
uniform vec3 color_GxMaterialColor84;
uniform vec3 color_GxAmbientColor84;
uniform float scalar_GxMaterialAlpha84;
uniform float scalar_GxAmbientAlpha84;
...
void main() {
  ...
  vec3 colorComponent = clamp(texture(texture0, uv0).rgb*color_GxMaterialColor84*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor84), 0, 1), 0, 1);

  float alphaComponent = texture(texture0, uv0).a*scalar_GxMaterialAlpha84*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha84);

  fragColor = vec4(colorComponent, alphaComponent);
}
ure0, uv0).rgb*clamp(vec3(scalar_GxMaterialAlpha83*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha83))*texture(texture2, uv0).rgb*texture(texture1, acos(normalUv) / 3.14159).rgb*vec3(0.5), 0, 1), 0, 1);
...
).x, (uv0).y, 1)).rgb*texture(texture1.sampler, texture1.transform2d * vec3((acos(normalUv) / 3.14159).x, (acos(normalUv) / 3.14159).y, 1)).rgb*vec3(4), 0, 1), 0, 1);

  float alphaComponent = scalar_GxMaterialAlpha42*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha42);
