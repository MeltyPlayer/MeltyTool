...
uniform vec3 color_GxMaterialColor67;
uniform vec3 color_GxAmbientColor67;
uniform float scalar_GxMaterialAlpha67;
uniform float scalar_GxAmbientAlpha67;
...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor67*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor67), 0, 1)*texture(texture0, uv0).rgb, 0, 1);

  float alphaComponent = scalar_GxMaterialAlpha67*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha67)*texture(texture0, uv0).a;
