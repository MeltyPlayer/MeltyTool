...
uniform vec3 color_GxMaterialColor59;
uniform vec3 color_GxAmbientColor59;
uniform float scalar_GxMaterialAlpha59;
uniform float scalar_GxAmbientAlpha59;
...
void main() {
  ...
  vec3 colorComponent = texture(texture1, uv1).rgb*clamp(texture(texture0, uv0).rgb*color_GxMaterialColor59*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor59), 0, 1), 0, 1);

  float alphaComponent = scalar_GxMaterialAlpha59*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha59);
