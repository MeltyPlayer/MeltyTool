...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor8*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor8), 0, 1), 0, 1);
