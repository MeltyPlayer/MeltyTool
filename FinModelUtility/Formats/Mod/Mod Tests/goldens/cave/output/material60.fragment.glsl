...
uniform vec3 color_GxMaterialColor60;
uniform vec3 color_GxAmbientColor60;
uniform float scalar_GxMaterialAlpha60;
uniform float scalar_GxAmbientAlpha60;
...
void main() {
  ...
  vec3 colorComponent = clamp((color_GxMaterialColor60*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor60), 0, 1)*texture(texture0, uv0).rgb + color_GxMaterialColor60*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor60), 0, 1)*texture(texture0, uv0).rgb*clamp(texture(texture1, uv0).rgb*color_GxMaterialColor60*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor60), 0, 1), 0, 1)), 0, 1)*vec3(texture(texture2, uv1).a);

  float alphaComponent = scalar_GxMaterialAlpha60*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha60);
