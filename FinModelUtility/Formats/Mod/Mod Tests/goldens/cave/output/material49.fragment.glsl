...
uniform vec3 color_GxMaterialColor49;
uniform vec3 color_GxAmbientColor49;
uniform float scalar_GxMaterialAlpha49;
uniform float scalar_GxAmbientAlpha49;
...
void main() {
  ...
  vec3 colorComponent = clamp(clamp(color_GxMaterialColor49*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor49), 0, 1)*texture(texture0, uv0).rgb, 0, 1) + color_GxMaterialColor49*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor49), 0, 1)*texture(texture0, uv0).rgb*clamp(vec3(scalar_GxMaterialAlpha49*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha49))*texture(texture1, acos(normalUv) / 3.14159).rgb*texture(texture2, uv0).rgb, 0, 1), 0, 1);

  float alphaComponent = scalar_GxMaterialAlpha49*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha49);
