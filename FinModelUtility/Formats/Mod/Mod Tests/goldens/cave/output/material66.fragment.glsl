...
uniform vec3 color_GxMaterialColor66;
uniform vec3 color_GxAmbientColor66;
uniform float scalar_GxMaterialAlpha66;
uniform float scalar_GxAmbientAlpha66;
...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor66*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor66), 0, 1)*texture(texture0, uv0).rgb + color_GxMaterialColor66*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor66), 0, 1)*texture(texture0, uv0).rgb*clamp(color_GxMaterialColor66*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor66), 0, 1)*texture(texture1, uv1).rgb, 0, 1), 0, 1);

  float alphaComponent = texture(texture0, uv0).a*scalar_GxMaterialAlpha66*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha66);
