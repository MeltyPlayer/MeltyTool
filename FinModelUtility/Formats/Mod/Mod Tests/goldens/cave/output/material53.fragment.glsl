...
uniform float scalar_GxAmbientAlpha53;
...
void main() {
  ...
  vec3 colorComponent = clamp(clamp(color_GxMaterialColor53*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor53), 0, 1)*texture(texture0, uv0).rgb, 0, 1) + color_GxMaterialColor53*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor53), 0, 1)*texture(texture0, uv0).rgb*clamp(vec3(scalar_GxMaterialAlpha53*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha53))*texture(texture2, uv0).rgb*texture(texture1, acos(normalUv) / 3.14159).rgb*vec3(0.5), 0, 1), 0, 1);

  float alphaComponent = scalar_GxMaterialAlpha53*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha53);
