...
uniform vec3 color_GxMaterialColor34;
uniform vec3 color_GxAmbientColor34;
uniform float scalar_GxMaterialAlpha34;
uniform float scalar_GxAmbientAlpha34;
...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor34*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor34), 0, 1), 0, 1);

  float alphaComponent = scalar_GxAlpha0*scalar_GxMaterialAlpha34*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha34);
