...
uniform vec3 color_GxMaterialColor65;
uniform vec3 color_GxAmbientColor65;
uniform float scalar_GxMaterialAlpha65;
uniform float scalar_GxAmbientAlpha65;
...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor65*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor65), 0, 1)*texture(texture0, uv0).rgb, 0, 1);

  float alphaComponent = texture(texture0, uv0).a*scalar_GxMaterialAlpha65*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha65);
