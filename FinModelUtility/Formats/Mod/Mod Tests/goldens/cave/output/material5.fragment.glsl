...
void main() {
  ...
  float alphaComponent = texture(texture1, uv1).a*scalar_GxMaterialAlpha5*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha5);
