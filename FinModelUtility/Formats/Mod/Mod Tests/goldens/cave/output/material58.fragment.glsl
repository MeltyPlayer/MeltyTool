...
uniform vec3 color_GxMaterialColor58;
uniform vec3 color_GxAmbientColor58;
uniform float scalar_GxMaterialAlpha58;
uniform float scalar_GxAmbientAlpha58;
...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor58*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor58), 0, 1)*texture(texture1, uv1).rgb*texture(texture0, uv0).rgb, 0, 1);

  float alphaComponent = (texture(texture0, uv0).a*0.4980392156862745 + texture(texture1, uv1).a*0.5019607843137255)*scalar_GxMaterialAlpha58*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha58);
