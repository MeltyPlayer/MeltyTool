...
void main() {
  ...
  float alphaComponent = texture(texture1, uv1).a*vertexColor0.a*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + vertexColor0.a);
