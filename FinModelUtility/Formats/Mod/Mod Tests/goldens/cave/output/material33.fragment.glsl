...
uniform vec3 color_GxMaterialColor33;
uniform vec3 color_GxAmbientColor33;
uniform float scalar_GxMaterialAlpha33;
uniform float scalar_GxAmbientAlpha33;
...
void main() {
  ...
  vec3 colorComponent = color_GxMaterialColor33*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor33), 0, 1)*(vec3(1) + vec3(-1)*texture(texture0, uv0).rgb*vec3(2)*texture(texture1, uv0).rgb)*vec3(4);

  float alphaComponent = texture(texture0, uv0).a*scalar_GxMaterialAlpha33*(individualLightDiffuseColors[0].a + individualLightDiffuseColors[1].a + individualLightDiffuseColors[2].a + scalar_GxAmbientAlpha33)*texture(texture1, uv0).a*0.5;
