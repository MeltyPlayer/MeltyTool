...
void main() {
  ...
  vec3 colorComponent = clamp(color_GxMaterialColor2*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + color_GxAmbientColor2), 0, 1)*(vec3(1) + vec3(-1)*color_GxColor0) + color_GxColor0, 0, 1);
