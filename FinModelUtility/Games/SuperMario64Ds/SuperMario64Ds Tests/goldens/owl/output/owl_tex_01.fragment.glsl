...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.498039215803) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.96862745285)*texture(texture0.sampler, texture0.transform2d * vec3((uv0).x, (uv0).y, 1)).rgb;
