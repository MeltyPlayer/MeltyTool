...
public sealed class Model : Animable {
	...
	public void method466() {
		...
		anInt1653 = (int) (Math.Sqrt(anInt1650 * anInt1650 + modelHeight * modelHeight) + 0.98999999999999999D);
	...
	private void method468() {
		...
		anInt1653 = (int) Math.Sqrt(anInt1650 * anInt1650 + modelHeight * modelHeight);
	...
	public void method479(int i, int j, int k, int l, int i1, bool flag) {
	...
	public void method443(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
		...
		int l4 = j4 + (modelHeight * k >> 16);
		int i5 = i4 - l4 << 9;
		if (i5 / i3 >= DrawingArea.anInt1387) {
			return;
		}
		int j5 = l2 + (modelHeight * j >> 16);
		bool flag = false;
		if (k2 - j5 <= 50) {
			flag = true;
		}
	...
	private void method484(int i) {
		...
		Texture.abool1462 = aboolArray1663[i];
		if (anIntArray1639 == null) {
			Texture.anInt1465 = 0;
		} else {
	...
	public static readonly Model aModel_1621 = new Model();
	...
	private static readonly int[] anIntArray1678 = new int[10];
	private static readonly int[] anIntArray1679 = new int[10];
	private static readonly int[] anIntArray1680 = new int[10];
	...
	public static readonly int[] anIntArray1688 = new int[1000];
