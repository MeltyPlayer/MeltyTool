...
void main() {
  ...
  vec3 colorComponent = mergedLightDiffuseColor.rgb*vec3(2.0)*vec3(0.176470592618,0.176470592618,0.203921571374) + vec3(0.458823531866)*mergedLightSpecularColor.rgb;
