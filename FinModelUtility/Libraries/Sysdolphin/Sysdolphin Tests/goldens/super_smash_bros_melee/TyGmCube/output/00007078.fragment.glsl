...
void main() {
  ...
  vec3 colorComponent = (vec3(0.098039217293)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.298039227724) + vec3(0.764705896378,0.800000011921,0.800000011921)*mergedLightSpecularColor.rgb;
