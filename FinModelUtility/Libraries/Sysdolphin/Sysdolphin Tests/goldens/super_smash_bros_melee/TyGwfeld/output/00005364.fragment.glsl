...
void main() {
  ...
  vec3 colorComponent = (vec3(0.04705882445,0.298039227724,0.04705882445)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.04705882445,0.298039227724,0.04705882445);
