...
void main() {
  ...
  vec3 colorComponent = (vec3(0.20000000298,0.501960813999,0.0)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.20000000298,0.501960813999,0.0);
