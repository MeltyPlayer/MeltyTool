...
void main() {
  ...
  vec3 colorComponent = (vec3(0.600000023842,0.600000023842,0.549019634724)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.701960802078,0.68235296011,0.65098041296);
