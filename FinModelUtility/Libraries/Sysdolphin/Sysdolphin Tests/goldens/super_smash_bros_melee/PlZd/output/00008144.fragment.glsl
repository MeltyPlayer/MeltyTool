...
void main() {
  ...
  vec3 colorComponent = (vec3(0.501960813999,0.298039227724,0.600000023842)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0, uv0).rgb + mergedLightSpecularColor.rgb;
