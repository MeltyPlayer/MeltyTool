...
void main() {
  ...
  vec3 colorComponent = ((vec3(0.501960813999)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.800000011921) + vec3(0.701960802078)*mergedLightSpecularColor.rgb)*texture(texture0, sphericalReflectionUv).rgb;
