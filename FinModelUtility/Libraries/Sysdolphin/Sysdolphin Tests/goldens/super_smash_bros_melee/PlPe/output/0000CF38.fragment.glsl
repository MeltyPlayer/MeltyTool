...
void main() {
  ...
  vec3 colorComponent = (vec3(0.20000000298,0.223529413342,0.250980407)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0.sampler, transformUv3d(texture0.transform3d, uv0)).rgb + vec3(0.764705896378,0.784313738346,0.807843148708)*mergedLightSpecularColor.rgb;
