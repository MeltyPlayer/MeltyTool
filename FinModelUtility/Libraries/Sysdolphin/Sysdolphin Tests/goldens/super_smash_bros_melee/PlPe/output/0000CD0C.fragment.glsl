...
void main() {
  ...
  vec3 colorComponent = (vec3(0.376470595598,0.305882364511,0.019607843831)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.580392181873,0.439215689898,0.0);
