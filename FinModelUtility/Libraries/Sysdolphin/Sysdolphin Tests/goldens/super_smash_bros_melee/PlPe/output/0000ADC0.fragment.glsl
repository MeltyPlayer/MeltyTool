...
void main() {
  ...
  vec3 colorComponent = (vec3(0.776470601559,0.741176486015,0.72549021244)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0, uv0).rgb;
