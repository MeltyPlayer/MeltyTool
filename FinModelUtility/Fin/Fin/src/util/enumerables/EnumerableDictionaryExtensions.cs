...
public static class EnumerableDictionaryExtensions {
  public static ISparseIndexableDictionary<T, int>
  ...
  public static ISparseIndexableDictionary<TKey, TValue> ToIndexableDictionary<
  ...
  public static ISparseIndexableDictionary<TKey, TValue> ToIndexableDictionary<
      ...
      where TKey : IIndexable {
    var indexableDictionary = new SparseIndexableDictionary<TKey, TValue>();
