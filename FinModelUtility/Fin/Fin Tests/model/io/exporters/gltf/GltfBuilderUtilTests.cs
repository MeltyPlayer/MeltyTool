...
namespace fin.model.io.exporters.gltf {
  public class GltfBuilderUtilTests {
    ...
    [TestCase(0, 3, ExpectedResult = typeof(VertexTexture2))]
    ...
    [TestCase(1, 3, ExpectedResult = typeof(VertexColor1Texture2))]
    ...
    [TestCase(2, 3, ExpectedResult = typeof(VertexColor2Texture2))]
    [TestCase(3, 0, ExpectedResult = typeof(VertexColor2))]
    [TestCase(3, 1, ExpectedResult = typeof(VertexColor2Texture1))]
    [TestCase(3, 2, ExpectedResult = typeof(VertexColor2Texture2))]
    [TestCase(3, 3, ExpectedResult = typeof(VertexColor2Texture2))]
